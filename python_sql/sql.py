...
ontime_2001 = pd.read_csv("../files/2001.csv")
ontime_2002 = pd.read_csv("../files/2002.csv")
...
combine_ontimes = pd.concat([ontime_2000, ontime_2001, ontime_2002, ontime_2003, ontime_2004, ontime_2005], ignore_index=True)

combine_ontimes.to_sql('ontime', con = conn, index = False)
